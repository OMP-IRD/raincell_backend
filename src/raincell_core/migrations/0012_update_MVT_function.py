# Generated by Django 3.2.13 on 2022-06-16 17:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('raincell_core', '0011_rename_if_fake_rainrecord_is_fake'),
    ]
        ...
        migrations.RunSQL(
            ...
            BEGIN
				...
				aggregated_records AS (
					SELECT cell_id, jsonb_agg(quantiles50) AS quantiles50
					FROM (
						SELECT
							cell_id,
							recorded_day,
						...
						WHERE recorded_day BETWEEN ref_date::date  - '1 days'::interval AND ref_date
