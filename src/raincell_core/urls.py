...
urlpatterns = [
    ...
    # re_path(r'^api/v1/raincell/cells/(?P<cell_id>[0-9]{16})/data/(?P<mode>all|daily)$', views.CellDailyRecordsById.as_view(), name="get-dailyrecords-by-id"),
    # re_path(r'^api/v1/raincell/cells/(?P<cell_id>[0-9]{16})/data/$', views.RainRecordsById.as_view(), name="get-records-by-id"),
