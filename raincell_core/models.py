...
class CellRecord(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["location", "recorded_day"], name="unique_location_day"),
            models.UniqueConstraint(fields=["cell_id", "recorded_day"], name="unique_cellid_day"),
        ]
        indexes = [
